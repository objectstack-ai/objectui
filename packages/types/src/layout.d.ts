 ...
 */
export type LayoutSchema = DivSchema | SpanSchema | TextSchema | ImageSchema | IconSchema | SeparatorSchema | ContainerSchema | FlexSchema | GridSchema | CardSchema | TabsSchema | ScrollAreaSchema | ResizableSchema | PageSchema;
