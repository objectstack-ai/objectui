 ...
 */
export type DataDisplaySchema = AlertSchema | BadgeSchema | AvatarSchema | ListSchema | TableSchema | DataTableSchema | MarkdownSchema | TreeViewSchema | ChartSchema | TimelineSchema;
