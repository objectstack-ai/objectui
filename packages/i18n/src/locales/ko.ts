const ko = {
  ...
  calendar: {
    ...
    configRequired: "캘린더 설정이 필요합니다. startDateField를 지정하세요. 캘린더의 유일한 필수 키입니다. 일정 제목은 titleField 없이도 확인됩니다.",
    configRequiredHint: "뷰의 calendar 블록에 속합니다. 인터페이스 페이지에는 자체 캘린더 슬롯이 없습니다. sourceView를 캘린더를 선언한 뷰로 지정하세요.",
    eventDetails: "일정 세부 정보",
    pullToRefresh: "당겨서 새로고침",
    refreshing: "새로고침 중…",
    onDate: "{{date}}",
    eventTitle: "제목",
  ...
  empty: {
    ...
    appNotAvailableDescription: "이 앱을 사용할 수 없습니다 — 잠시 후 다시 시도하세요.",
    appNotFound: "이 앱을 열 수 없습니다",
    appNotFoundDescription: "서버가 회원님의 계정에 대해 이 앱을 반환하지 않았습니다.",
    appUnreachable: "서버에 연결할 수 없습니다",
    appUnreachableDescription: "이 앱을 확인할 수 없습니다. 잠시 후 다시 시도하세요.",
