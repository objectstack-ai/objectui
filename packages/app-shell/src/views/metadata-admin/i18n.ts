...
const ENGINE_STRINGS_EN: Record<string, string> = {
  ...
  // ConditionBuilder row mode (objectui#10586). `≥` / `≤` stay symbols.
  'engine.inspector.condition.builder': 'Builder',
  'engine.inspector.condition.expression': 'Expression',
  'engine.inspector.condition.always': 'Always — no condition.',
  'engine.inspector.condition.and': 'AND',
  'engine.inspector.condition.or': 'OR',
  'engine.inspector.condition.subjectPlaceholder': 'field / context',
  'engine.inspector.condition.remove': 'Remove condition',
  'engine.inspector.condition.valuePlaceholder': 'value',
  'engine.inspector.condition.add': 'Add condition',
  'engine.inspector.condition.op.equals': 'equals',
  'engine.inspector.condition.op.notEquals': 'not equals',
  'engine.inspector.condition.op.greaterThan': 'greater than',
  ...
  // Hook default (home) inspector (objectui#10586). Event names, code samples
  // and the priority digits stay literal: they are identifiers, not words.
  'engine.inspector.hook.bodyLang.expression': 'Expression (L1)',
  'engine.inspector.hook.bodyLang.js': 'Sandboxed JS (L2)',
  'engine.inspector.hook.basics': 'Basics',
  'engine.inspector.hook.label': 'Label',
  'engine.inspector.hook.labelPlaceholder': 'Human-readable name',
  'engine.inspector.hook.name': 'Name',
  'engine.inspector.hook.namePlaceholder': 'snake_case identifier',
  'engine.inspector.hook.objects': 'Object(s) this hook fires on',
  ...
  'engine.inspector.hook.eventsQuery': 'Query',
  'engine.inspector.hook.pickEvent': 'Select at least one event.',
  'engine.inspector.hook.function': 'Function',
  'engine.inspector.hook.functionHint': 'The handler that runs when the hook fires.',
  'engine.inspector.hook.language': 'Language',
  'engine.inspector.hook.handlerBody': 'Handler body',
  'engine.inspector.hook.bodyHint.expression': 'A single L1 expression evaluated against the record / ctx.',
  'engine.inspector.hook.bodyHint.js': 'Runs in the sandbox as (ctx) => Promise<void>.',
  'engine.inspector.hook.options': 'Options',
  'engine.inspector.hook.priority': 'Priority',
  'engine.inspector.hook.async': 'Run asynchronously (after commit)',
  'engine.inspector.hook.condition': 'Run only when (optional CEL)',
  'engine.inspector.hook.moreFieldsHint': 'Advanced / rarely-used properties.',
  // Action default (home) inspector (objectui#10586). Option labels are keyed
  // by the stored value; `{…}` tokens are slots the inspector fills with a
  // node (a code span, a capability list). HTTP methods, `↑` / `↓` and the
  // path / dotted-key samples stay literal.
  'engine.inspector.action.type.script': 'Script — run an expression / sandboxed JS',
  'engine.inspector.action.type.api': 'API — call an endpoint',
  'engine.inspector.action.type.flow': 'Flow — invoke a flow',
  'engine.inspector.action.type.modal': 'Modal — open a modal/page',
  'engine.inspector.action.type.form': 'Form — open a FormView',
  'engine.inspector.action.type.url': 'URL — navigate to a link',
  'engine.inspector.action.variant.primary': 'Primary',
  'engine.inspector.action.variant.secondary': 'Secondary',
  'engine.inspector.action.variant.danger': 'Danger',
  'engine.inspector.action.variant.ghost': 'Ghost',
  'engine.inspector.action.variant.link': 'Link',
  'engine.inspector.action.component.button': 'Button',
  'engine.inspector.action.component.icon': 'Icon only',
  'engine.inspector.action.component.menu': 'Menu item',
  'engine.inspector.action.component.group': 'Button group',
  'engine.inspector.action.mode.create': 'Create',
  'engine.inspector.action.mode.edit': 'Edit',
  'engine.inspector.action.mode.delete': 'Delete',
  'engine.inspector.action.mode.custom': 'Custom',
  'engine.inspector.action.bodyLang.expression': 'Expression (L1)',
  'engine.inspector.action.bodyLang.js': 'Sandboxed JS (L2)',
  'engine.inspector.action.paramType.text': 'Text',
  'engine.inspector.action.paramType.textarea': 'Long text',
  'engine.inspector.action.paramType.number': 'Number',
  'engine.inspector.action.paramType.boolean': 'Checkbox',
  'engine.inspector.action.paramType.select': 'Select',
  'engine.inspector.action.paramType.date': 'Date',
  'engine.inspector.action.paramType.datetime': 'Date/time',
  'engine.inspector.action.paramType.lookup': 'Lookup',
  'engine.inspector.action.location.record_header': 'Record header',
  'engine.inspector.action.location.record_more': 'Record · more menu',
  'engine.inspector.action.location.record_section': 'Record · section',
  'engine.inspector.action.location.record_related': 'Record · related list',
  'engine.inspector.action.location.list_toolbar': 'List toolbar',
  'engine.inspector.action.location.list_item': 'List · row',
  'engine.inspector.action.target.url.label': 'URL',
  'engine.inspector.action.target.url.placeholder': 'https://… or /path?x=${param.x}',
  'engine.inspector.action.target.url.hint': 'Supports ${param.x} and ${ctx.x} interpolation.',
  'engine.inspector.action.target.flow.label': 'Flow name',
  'engine.inspector.action.target.flow.placeholder': 'snake_case flow',
  'engine.inspector.action.target.flow.hint': 'The flow to invoke when clicked.',
  'engine.inspector.action.target.modal.label': 'Modal / page name',
  'engine.inspector.action.target.modal.placeholder': 'snake_case page',
  'engine.inspector.action.target.modal.hint': 'The modal or page to open.',
  'engine.inspector.action.target.form.label': 'Form view name',
  'engine.inspector.action.target.form.hint': 'Opens /console/forms/<name>.',
  'engine.inspector.action.target.api.label': 'API endpoint',
  'engine.inspector.action.target.api.hint': 'Endpoint called with the request body below.',
  'engine.inspector.action.scriptOp.run': 'Run a script — sandboxed JS / expression body',
  'engine.inspector.action.scriptOp.update': 'Update fields on this record — no code',
  'engine.inspector.action.objectPlaceholder': 'snake_case object',
  'engine.inspector.action.objectNone': '— None (global) —',
  'engine.inspector.action.options': 'Options',
  'engine.inspector.action.optionsEmpty': 'No choices yet — a Select with no options opens an empty picker in the dialog.',
  'engine.inspector.action.optionLabel': 'Label',
  'engine.inspector.action.optionValue': 'Value',
  'engine.inspector.action.removeOption': 'Remove option {index}',
  'engine.inspector.action.addOption': 'Add option',
  'engine.inspector.action.basics': 'Basics',
  'engine.inspector.action.label': 'Label',
  'engine.inspector.action.labelPlaceholder': 'Button text shown to users',
  'engine.inspector.action.name': 'Name',
  'engine.inspector.action.namePlaceholder': 'snake_case identifier',
  'engine.inspector.action.object': 'Object',
  'engine.inspector.action.objectBoundHint': 'Bound action — surfaces in this object’s views per the placement below.',
  'engine.inspector.action.objectGlobalHint': 'Empty = global action — must be referenced by a page’s quick actions, global nav, a flow, or AI to appear.',
  'engine.inspector.action.icon': 'Icon',
  'engine.inspector.action.variant': 'Variant',
  'engine.inspector.action.behavior': 'Behavior',
  'engine.inspector.action.behaviorHint': 'What happens when the action is triggered.',
  'engine.inspector.action.type': 'Type',
  'engine.inspector.action.pinnedScript': 'Pinned to {script}: the field write is performed on the platform action route, which is this type’s own route. Any other type is refused beside it.',
  'engine.inspector.action.whatItDoes': 'What it does',
  'engine.inspector.action.fieldValues': 'Field values',
  'engine.inspector.action.fieldValuesEmpty': 'No field values yet — add one, or collect the value as an input below.',
  'engine.inspector.action.fieldValueField': 'Field',
  'engine.inspector.action.fieldValueValue': 'Value',
  'engine.inspector.action.removeFieldValue': 'Remove field value',
  'engine.inspector.action.addFieldValue': 'Add field value',
  'engine.inspector.action.updateHint': 'Written to the current record as the caller — object permissions, hooks and validations fire as for a user edit. An input collected below with the same name overrides the fixed value here.',
  'engine.inspector.action.scriptLanguage': 'Script language',
  'engine.inspector.action.scriptBody': 'Script body',
  'engine.inspector.action.scriptBodyHint': 'Runs in the sandbox as {signature}.',
  'engine.inspector.action.method': 'Method',
  'engine.inspector.action.inputs': 'Inputs',
  'engine.inspector.action.inputsHint': 'Collected from the user in a dialog before the action runs.',
  'engine.inspector.action.inputsEmpty': 'No inputs — the action runs immediately on click.',
  'engine.inspector.action.removeInput': 'Remove input',
  'engine.inspector.action.bindToField': 'Bind to field',
  'engine.inspector.action.paramName': 'Name',
  'engine.inspector.action.paramNamePlaceholder': 'request-body key',
  'engine.inspector.action.paramLabel': 'Label',
  'engine.inspector.action.paramTypeLabel': 'Type',
  'engine.inspector.action.paramPlaceholder': 'Placeholder',
  'engine.inspector.action.paramRequired': 'Required',
  'engine.inspector.action.paramPrefill': 'Pre-fill from row',
  'engine.inspector.action.addInput': 'Add input',
  'engine.inspector.action.placement': 'Placement',
  'engine.inspector.action.placementHint': 'Where this action surfaces in the UI.',
  'engine.inspector.action.noPlacement': 'No placement selected — this action will not appear on any record or list surface. Tick a placement above, or place it from a view’s bulk actions.',
  'engine.inspector.action.capabilityGate': 'Capability-gated on {capabilities} — every placement ticked above hides this action from anyone who does not hold {whom}. Not greyed out and not an error: the button is simply absent, and the server refuses the invocation with a 403 either way.',
  'engine.inspector.action.capabilityGateAll': 'all of them',
  'engine.inspector.action.capabilityGateOne': 'it',
  'engine.inspector.action.capabilityGateSelf': 'This session does not hold {capabilities}, so the button is hidden from you too — grant it through a permission set to see it in the app.',
  'engine.inspector.action.component': 'Component',
  'engine.inspector.action.feedback': 'Feedback',
  'engine.inspector.action.feedbackHint': 'Confirmation and post-run messaging.',
  'engine.inspector.action.confirmText': 'Confirm prompt',
  'engine.inspector.action.confirmTextPlaceholder': 'Ask before running (leave blank to skip)',
  'engine.inspector.action.successMessage': 'Success message',
  'engine.inspector.action.errorMessage': 'Error message',
  'engine.inspector.action.mode': 'Mode',
  'engine.inspector.action.refreshAfter': 'Refresh view after',
  'engine.inspector.action.undoable': 'Offer undo',
  'engine.inspector.action.conditions': 'Conditions',
  'engine.inspector.action.conditionsHint': 'No-code predicates over the record / user / ctx (compiled to CEL).',
  'engine.inspector.action.visibleWhen': 'Visible when',
  'engine.inspector.action.disabledWhen': 'Disabled when',
  'engine.inspector.action.ai': 'AI exposure',
  'engine.inspector.action.aiHint': 'Opt-in: expose this action to AI agents as a callable tool.',
  'engine.inspector.action.aiExposed': 'Expose to AI agents',
  'engine.inspector.action.aiDescription': 'Tool description (required, ≥40 chars)',
  'engine.inspector.action.aiDescriptionPlaceholder': 'When and why an agent should call this action…',
  'engine.inspector.action.aiDescriptionTooShort': 'A ≥40-character description is required while exposed.',
  'engine.inspector.action.moreFieldsHint': 'Advanced / rarely-used properties.',
  ...
  // Dataset default (home) inspector (objectui#10586). Option labels are keyed
  // by the stored value; `{…}` tokens in a sentence are slots the inspector
  // fills with a node (a code span, a count).
  'engine.inspector.dataset.kind': 'Dataset',
  'engine.inspector.dataset.aggregate.count': 'count',
  'engine.inspector.dataset.aggregate.sum': 'sum',
  'engine.inspector.dataset.aggregate.avg': 'avg',
  'engine.inspector.dataset.aggregate.min': 'min',
  'engine.inspector.dataset.aggregate.max': 'max',
  'engine.inspector.dataset.aggregate.count_distinct': 'count distinct',
  'engine.inspector.dataset.dimType.string': 'string',
  'engine.inspector.dataset.dimType.number': 'number',
  'engine.inspector.dataset.dimType.date': 'date',
  'engine.inspector.dataset.dimType.boolean': 'boolean',
  'engine.inspector.dataset.dimType.lookup': 'lookup',
  'engine.inspector.dataset.granularity.none': '— none —',
  'engine.inspector.dataset.granularity.day': 'day',
  'engine.inspector.dataset.granularity.week': 'week',
  'engine.inspector.dataset.granularity.month': 'month',
  'engine.inspector.dataset.granularity.quarter': 'quarter',
  'engine.inspector.dataset.granularity.year': 'year',
  'engine.inspector.dataset.derivedOp.ratio': 'ratio (a ÷ b)',
  'engine.inspector.dataset.derivedOp.sum': 'sum (a + b)',
  'engine.inspector.dataset.derivedOp.difference': 'difference (a − b)',
  'engine.inspector.dataset.derivedOp.product': 'product (a × b)',
  'engine.inspector.dataset.formatKind.raw': 'Raw number',
  'engine.inspector.dataset.formatKind.number': 'Number — 1,234.5',
  'engine.inspector.dataset.formatKind.currency': 'Currency — $1,234.50',
  'engine.inspector.dataset.formatKind.percent': 'Percent — 12.3%',
  'engine.inspector.dataset.usage.bound': 'Bound by {reports} · {dashboards} — changes affect them.',
  'engine.inspector.dataset.usage.reportsOne': '{count} report',
  'engine.inspector.dataset.usage.reportsOther': '{count} reports',
  'engine.inspector.dataset.usage.dashboardsOne': '{count} dashboard',
  'engine.inspector.dataset.usage.dashboardsOther': '{count} dashboards',
  'engine.inspector.dataset.usage.unbound': 'Not yet bound by any report or dashboard.',
  'engine.inspector.dataset.name': 'Name',
  'engine.inspector.dataset.namePlaceholder': 'snake_case identifier',
  'engine.inspector.dataset.label': 'Label',
  'engine.inspector.dataset.description': 'Description',
  'engine.inspector.dataset.baseObject': 'Base object',
  'engine.inspector.dataset.baseObjectPlaceholder': 'Select an object…',
  'engine.inspector.dataset.searchObjects': 'Search objects…',
  'engine.inspector.dataset.baseObjectChangeHint': 'Changing the base object clears its dimensions, measures, joins & filters.',
  'engine.inspector.dataset.includedRelationships': 'Included relationships',
  'engine.inspector.dataset.noJoins': 'No joins. Add a relationship (a lookup field on {object}) to use {path} dimensions/measures.',
  'engine.inspector.dataset.baseObjectFallback': 'the base object',
  'engine.inspector.dataset.includedRelationship': 'Included relationship',
  'engine.inspector.dataset.relationshipPlaceholder': 'Select a relationship…',
  'engine.inspector.dataset.searchRelationships': 'Search relationships…',
  'engine.inspector.dataset.removeRelationship': 'Remove relationship',
  'engine.inspector.dataset.scopeFilter': 'Scope filter',
  'engine.inspector.dataset.scopeFilterHelp': 'Intrinsic scope, ANDed into every query (e.g. exclude soft-deleted records).',
  'engine.inspector.dataset.dimensions': 'Dimensions',
  'engine.inspector.dataset.addDimension': 'Add dimension',
  'engine.inspector.dataset.dimensionN': 'Dimension {index}',
  'engine.inspector.dataset.removeDimension': 'Remove dimension',
  'engine.inspector.dataset.dimensionNamePlaceholder': 'e.g. region',
  'engine.inspector.dataset.field': 'Field',
  'engine.inspector.dataset.dimensionFieldPlaceholder': 'field or relationship.field',
  'engine.inspector.dataset.type': 'Type',
  'engine.inspector.dataset.labelOptional': 'Label (optional)',
  'engine.inspector.dataset.displayLabel': 'Display label',
  'engine.inspector.dataset.dateBucket': 'Date bucket',
  'engine.inspector.dataset.measures': 'Measures',
  'engine.inspector.dataset.addMeasure': 'Add measure',
  'engine.inspector.dataset.measureN': 'Measure {index}',
  'engine.inspector.dataset.removeMeasure': 'Remove measure',
  'engine.inspector.dataset.measureNamePlaceholder': 'e.g. revenue',
  'engine.inspector.dataset.aggregate': 'Aggregate',
  'engine.inspector.dataset.measureFieldPlaceholder': 'field (optional for count)',
  'engine.inspector.dataset.measureFilter': 'Filter (measure-scoped)',
  'engine.inspector.dataset.measureFilterHelp': 'Only rows matching this filter feed this measure (e.g. won_amount = sum(amount) where stage = won).',
  'engine.inspector.dataset.derived': 'Derived — computed from other measures',
  'engine.inspector.dataset.operation': 'Operation',
  'engine.inspector.dataset.operands': 'Operands (other measures)',
  'engine.inspector.dataset.derivedNeedTwo': 'Select exactly 2 measures for {op}.',
  'engine.inspector.dataset.derivedNeedOne': 'Select at least 1 measure for {op}.',
  'engine.inspector.dataset.addOtherMeasuresFirst': 'Add other measures first.',
  'engine.inspector.dataset.advanced': 'Advanced',
  'engine.inspector.dataset.displayFormat': 'Display format',
  'engine.inspector.dataset.decimals': 'Decimals',
  'engine.inspector.dataset.currency': 'Currency',
  'engine.inspector.dataset.sample': 'Sample: {sample}',
  'engine.inspector.dataset.relWarning': "Relationship {rel} isn't in Included relationships.",
  'engine.inspector.dataset.relWarningAdd': 'Add it',
  'engine.inspector.dataset.filterAdvanced': 'Advanced filter (nested / OR) — edit it in the {source} tab.',
  'engine.inspector.dataset.sourceTab': 'Source',
  'engine.inspector.dataset.filterConditionsOne': '{count} condition',
  'engine.inspector.dataset.filterConditionsOther': '{count} conditions',
  'engine.inspector.dataset.addFilter': '+ Add filter…',
  'engine.inspector.dataset.filterNeedsObject': 'Pick a base object to add filter conditions.',
  // Flow reference picker — ReferenceCombobox / FlowReferenceField (objectui#10586)
  'engine.inspector.reference.pickFromRecords': 'Pick from records',
  'engine.inspector.reference.enterManually': 'Enter value manually',
  'engine.inspector.reference.managerPlaceholder': 'Resolved automatically',
  'engine.inspector.reference.managerHint': "Resolved at runtime from the submitter's manager — no value needed.",
  'engine.inspector.reference.queueUnsupported': 'Queue approvers are not supported by the runtime yet — this slot resolves to nobody.',
  'engine.inspector.reference.fieldsOf': 'Fields of {object}.',
  'engine.inspector.reference.setTriggerObject': 'Set the flow’s trigger object (on the Start node) to list fields.',
  ...
  // InspectorComboField defaults (objectui#10586). `{value}` is the typed
  // text, drawn in a code span by the combo.
  'engine.inspector.combo.search': 'Search or type…',
  'engine.inspector.combo.noMatch': 'No match — keep typing to use a custom value.',
  'engine.inspector.combo.loading': 'Loading…',
  'engine.inspector.combo.useCustom': 'Use {value}',
...
const ENGINE_STRINGS_ZH: Record<string, string> = {
  ...
  // ConditionBuilder row mode (objectui#10586). The join words follow the
  // packs' own `filterBuilder.and` / `filterBuilder.or`.
  'engine.inspector.condition.builder': '搭建器',
  'engine.inspector.condition.expression': '表达式',
  'engine.inspector.condition.always': '始终生效 —— 无条件。',
  'engine.inspector.condition.and': '且',
  'engine.inspector.condition.or': '或',
  'engine.inspector.condition.subjectPlaceholder': '字段 / 上下文',
  'engine.inspector.condition.remove': '移除条件',
  'engine.inspector.condition.valuePlaceholder': '值',
  'engine.inspector.condition.add': '添加条件',
  'engine.inspector.condition.op.equals': '等于',
  'engine.inspector.condition.op.notEquals': '不等于',
  'engine.inspector.condition.op.greaterThan': '大于',
  ...
  // Hook default (home) inspector (objectui#10586).
  'engine.inspector.hook.bodyLang.expression': '表达式（L1）',
  'engine.inspector.hook.bodyLang.js': '沙箱 JS（L2）',
  'engine.inspector.hook.basics': '基本信息',
  'engine.inspector.hook.label': '显示名',
  'engine.inspector.hook.labelPlaceholder': '便于阅读的名称',
  'engine.inspector.hook.name': '名称',
  'engine.inspector.hook.namePlaceholder': 'snake_case 标识符',
  'engine.inspector.hook.objects': '此钩子触发的对象',
  ...
  'engine.inspector.hook.eventsQuery': '查询',
  'engine.inspector.hook.pickEvent': '请至少选择一个事件。',
  'engine.inspector.hook.function': '函数',
  'engine.inspector.hook.functionHint': '钩子触发时运行的处理函数。',
  'engine.inspector.hook.language': '语言',
  'engine.inspector.hook.handlerBody': '处理函数主体',
  'engine.inspector.hook.bodyHint.expression': '针对 record / ctx 求值的单个 L1 表达式。',
  'engine.inspector.hook.bodyHint.js': '在沙箱中以 (ctx) => Promise<void> 的形式运行。',
  'engine.inspector.hook.options': '选项',
  'engine.inspector.hook.priority': '优先级',
  'engine.inspector.hook.async': '异步运行（提交之后）',
  'engine.inspector.hook.condition': '仅在以下条件成立时运行（可选 CEL）',
  'engine.inspector.hook.moreFieldsHint': '高级 / 不常用的属性。',
  // Action default (home) inspector (objectui#10586). Wording follows the
  // catalogue's own rows: pageBlock's variant and location labels, the
  // `engine.fieldType.*` names, `designer.field.*` (显示名 / 占位符 / 必填).
  'engine.inspector.action.type.script': '脚本 —— 运行表达式 / 沙箱 JS',
  'engine.inspector.action.type.api': 'API —— 调用端点',
  'engine.inspector.action.type.flow': '流程 —— 调用流程',
  'engine.inspector.action.type.modal': '弹窗 —— 打开弹窗 / 页面',
  'engine.inspector.action.type.form': '表单 —— 打开表单视图',
  'engine.inspector.action.type.url': 'URL —— 跳转到链接',
  'engine.inspector.action.variant.primary': '主要',
  'engine.inspector.action.variant.secondary': '次要',
  'engine.inspector.action.variant.danger': '危险',
  'engine.inspector.action.variant.ghost': '幽灵',
  'engine.inspector.action.variant.link': '链接',
  'engine.inspector.action.component.button': '按钮',
  'engine.inspector.action.component.icon': '仅图标',
  'engine.inspector.action.component.menu': '菜单项',
  'engine.inspector.action.component.group': '按钮组',
  'engine.inspector.action.mode.create': '新建',
  'engine.inspector.action.mode.edit': '编辑',
  'engine.inspector.action.mode.delete': '删除',
  'engine.inspector.action.mode.custom': '自定义',
  'engine.inspector.action.bodyLang.expression': '表达式（L1）',
  'engine.inspector.action.bodyLang.js': '沙箱 JS（L2）',
  'engine.inspector.action.paramType.text': '单行文本',
  'engine.inspector.action.paramType.textarea': '多行文本',
  'engine.inspector.action.paramType.number': '数字',
  'engine.inspector.action.paramType.boolean': '复选框',
  'engine.inspector.action.paramType.select': '下拉选择',
  'engine.inspector.action.paramType.date': '日期',
  'engine.inspector.action.paramType.datetime': '日期时间',
  'engine.inspector.action.paramType.lookup': '查找关系',
  'engine.inspector.action.location.record_header': '记录头部',
  'engine.inspector.action.location.record_more': '记录 · 更多菜单',
  'engine.inspector.action.location.record_section': '记录 · 分区',
  'engine.inspector.action.location.record_related': '记录 · 关联列表',
  'engine.inspector.action.location.list_toolbar': '列表工具栏',
  'engine.inspector.action.location.list_item': '列表 · 行',
  'engine.inspector.action.target.url.label': 'URL 地址',
  'engine.inspector.action.target.url.placeholder': 'https://… 或 /path?x=${param.x}',
  'engine.inspector.action.target.url.hint': '支持 ${param.x} 与 ${ctx.x} 插值。',
  'engine.inspector.action.target.flow.label': '流程名称',
  'engine.inspector.action.target.flow.placeholder': 'snake_case 流程名',
  'engine.inspector.action.target.flow.hint': '点击时调用的流程。',
  'engine.inspector.action.target.modal.label': '弹窗 / 页面名称',
  'engine.inspector.action.target.modal.placeholder': 'snake_case 页面名',
  'engine.inspector.action.target.modal.hint': '要打开的弹窗或页面。',
  'engine.inspector.action.target.form.label': '表单视图名称',
  'engine.inspector.action.target.form.hint': '打开 /console/forms/<name>。',
  'engine.inspector.action.target.api.label': 'API 端点',
  'engine.inspector.action.target.api.hint': '使用下方请求体调用的端点。',
  'engine.inspector.action.scriptOp.run': '运行脚本 —— 沙箱 JS / 表达式主体',
  'engine.inspector.action.scriptOp.update': '更新此记录的字段 —— 无需代码',
  'engine.inspector.action.objectPlaceholder': 'snake_case 对象名',
  'engine.inspector.action.objectNone': '— 无（全局）—',
  'engine.inspector.action.options': '选项',
  'engine.inspector.action.optionsEmpty': '还没有选项 —— 没有选项的下拉选择会在对话框中打开一个空的选择器。',
  'engine.inspector.action.optionLabel': '显示名',
  'engine.inspector.action.optionValue': '值',
  'engine.inspector.action.removeOption': '移除选项 {index}',
  'engine.inspector.action.addOption': '添加选项',
  'engine.inspector.action.basics': '基本信息',
  'engine.inspector.action.label': '显示名',
  'engine.inspector.action.labelPlaceholder': '向用户显示的按钮文字',
  'engine.inspector.action.name': '名称',
  'engine.inspector.action.namePlaceholder': 'snake_case 标识符',
  'engine.inspector.action.object': '对象',
  'engine.inspector.action.objectBoundHint': '绑定动作 —— 按下方的放置位置出现在此对象的视图中。',
  'engine.inspector.action.objectGlobalHint': '留空 = 全局动作 —— 须被页面的快捷动作、全局导航、流程或 AI 引用后才会出现。',
  'engine.inspector.action.icon': '图标',
  'engine.inspector.action.variant': '样式',
  'engine.inspector.action.behavior': '行为',
  'engine.inspector.action.behaviorHint': '动作被触发时会发生什么。',
  'engine.inspector.action.type': '类型',
  'engine.inspector.action.pinnedScript': '已固定为 {script}：字段写入在平台动作路由上执行，而这正是该类型自己的路由。与它并存时，其他任何类型都会被拒绝。',
  'engine.inspector.action.whatItDoes': '作用',
  'engine.inspector.action.fieldValues': '字段值',
  'engine.inspector.action.fieldValuesEmpty': '还没有字段值 —— 添加一个，或在下方把该值作为输入项收集。',
  'engine.inspector.action.fieldValueField': '字段',
  'engine.inspector.action.fieldValueValue': '值',
  'engine.inspector.action.removeFieldValue': '移除字段值',
  'engine.inspector.action.addFieldValue': '添加字段值',
  'engine.inspector.action.updateHint': '以调用者身份写入当前记录 —— 对象权限、钩子与校验会像用户编辑时一样触发。下方收集的同名输入项会覆盖此处的固定值。',
  'engine.inspector.action.scriptLanguage': '脚本语言',
  'engine.inspector.action.scriptBody': '脚本主体',
  'engine.inspector.action.scriptBodyHint': '在沙箱中以 {signature} 的形式运行。',
  'engine.inspector.action.method': '请求方法',
  'engine.inspector.action.inputs': '输入项',
  'engine.inspector.action.inputsHint': '在动作运行前通过对话框向用户收集。',
  'engine.inspector.action.inputsEmpty': '没有输入项 —— 点击后立即运行动作。',
  'engine.inspector.action.removeInput': '移除输入项',
  'engine.inspector.action.bindToField': '绑定到字段',
  'engine.inspector.action.paramName': '名称',
  'engine.inspector.action.paramNamePlaceholder': '请求体键名',
  'engine.inspector.action.paramLabel': '显示名',
  'engine.inspector.action.paramTypeLabel': '类型',
  'engine.inspector.action.paramPlaceholder': '占位符',
  'engine.inspector.action.paramRequired': '必填',
  'engine.inspector.action.paramPrefill': '从行预填',
  'engine.inspector.action.addInput': '添加输入项',
  'engine.inspector.action.placement': '放置位置',
  'engine.inspector.action.placementHint': '此动作在界面中出现的位置。',
  'engine.inspector.action.noPlacement': '未选择放置位置 —— 此动作不会出现在任何记录或列表界面上。请在上方勾选一个放置位置，或通过视图的批量动作放置它。',
  'engine.inspector.action.capabilityGate': '受权限 {capabilities} 控制 —— 对于不具备{whom}的任何人，上方勾选的每个放置位置都会隐藏此动作。这不是置灰，也不是错误：按钮只是不出现，而且无论如何服务器都会以 403 拒绝调用。',
  'engine.inspector.action.capabilityGateAll': '全部这些权限',
  'engine.inspector.action.capabilityGateOne': '该权限',
  'engine.inspector.action.capabilityGateSelf': '当前会话不具备 {capabilities}，因此该按钮对你同样隐藏 —— 通过权限集授予后，即可在应用中看到它。',
  'engine.inspector.action.component': '组件',
  'engine.inspector.action.feedback': '反馈',
  'engine.inspector.action.feedbackHint': '确认提示与运行后的消息。',
  'engine.inspector.action.confirmText': '确认提示',
  'engine.inspector.action.confirmTextPlaceholder': '运行前询问（留空则跳过）',
  'engine.inspector.action.successMessage': '成功消息',
  'engine.inspector.action.errorMessage': '错误消息',
  'engine.inspector.action.mode': '模式',
  'engine.inspector.action.refreshAfter': '完成后刷新视图',
  'engine.inspector.action.undoable': '提供撤销',
  'engine.inspector.action.conditions': '条件',
  'engine.inspector.action.conditionsHint': '基于 record / user / ctx 的无代码判断条件（编译为 CEL）。',
  'engine.inspector.action.visibleWhen': '可见条件',
  'engine.inspector.action.disabledWhen': '禁用条件',
  'engine.inspector.action.ai': 'AI 开放',
  'engine.inspector.action.aiHint': '可选：将此动作作为可调用工具开放给 AI 智能体。',
  'engine.inspector.action.aiExposed': '开放给 AI 智能体',
  'engine.inspector.action.aiDescription': '工具描述（必填，≥40 个字符）',
  'engine.inspector.action.aiDescriptionPlaceholder': '智能体应在何时、出于何种目的调用此动作…',
  'engine.inspector.action.aiDescriptionTooShort': '开放期间必须提供至少 40 个字符的描述。',
  'engine.inspector.action.moreFieldsHint': '高级 / 不常用的属性。',
  // Dashboard default (home) inspector
  ...
  // Dataset default (home) inspector (objectui#10586). zh has one plural form,
  // so each `…One` / `…Other` pair carries the same row.
  'engine.inspector.dataset.kind': '数据集',
  'engine.inspector.dataset.aggregate.count': '计数',
  'engine.inspector.dataset.aggregate.sum': '求和',
  'engine.inspector.dataset.aggregate.avg': '平均值',
  'engine.inspector.dataset.aggregate.min': '最小值',
  'engine.inspector.dataset.aggregate.max': '最大值',
  'engine.inspector.dataset.aggregate.count_distinct': '去重计数',
  'engine.inspector.dataset.dimType.string': '字符串',
  'engine.inspector.dataset.dimType.number': '数字',
  'engine.inspector.dataset.dimType.date': '日期',
  'engine.inspector.dataset.dimType.boolean': '布尔值',
  'engine.inspector.dataset.dimType.lookup': '查找关系',
  'engine.inspector.dataset.granularity.none': '— 无 —',
  'engine.inspector.dataset.granularity.day': '日',
  'engine.inspector.dataset.granularity.week': '周',
  'engine.inspector.dataset.granularity.month': '月',
  'engine.inspector.dataset.granularity.quarter': '季度',
  'engine.inspector.dataset.granularity.year': '年',
  'engine.inspector.dataset.derivedOp.ratio': '比率（a ÷ b）',
  'engine.inspector.dataset.derivedOp.sum': '求和（a + b）',
  'engine.inspector.dataset.derivedOp.difference': '差值（a − b）',
  'engine.inspector.dataset.derivedOp.product': '乘积（a × b）',
  'engine.inspector.dataset.formatKind.raw': '原始数值',
  'engine.inspector.dataset.formatKind.number': '数字 —— 1,234.5',
  'engine.inspector.dataset.formatKind.currency': '货币 —— $1,234.50',
  'engine.inspector.dataset.formatKind.percent': '百分比 —— 12.3%',
  'engine.inspector.dataset.usage.bound': '已被 {reports} · {dashboards} 绑定 —— 修改会影响它们。',
  'engine.inspector.dataset.usage.reportsOne': '{count} 个报表',
  'engine.inspector.dataset.usage.reportsOther': '{count} 个报表',
  'engine.inspector.dataset.usage.dashboardsOne': '{count} 个仪表盘',
  'engine.inspector.dataset.usage.dashboardsOther': '{count} 个仪表盘',
  'engine.inspector.dataset.usage.unbound': '尚未被任何报表或仪表盘绑定。',
  'engine.inspector.dataset.name': '名称',
  'engine.inspector.dataset.namePlaceholder': 'snake_case 标识符',
  'engine.inspector.dataset.label': '显示名',
  'engine.inspector.dataset.description': '描述',
  'engine.inspector.dataset.baseObject': '基础对象',
  'engine.inspector.dataset.baseObjectPlaceholder': '选择对象…',
  'engine.inspector.dataset.searchObjects': '搜索对象…',
  'engine.inspector.dataset.baseObjectChangeHint': '更改基础对象会清空其维度、度量、关联与筛选。',
  'engine.inspector.dataset.includedRelationships': '包含的关联',
  'engine.inspector.dataset.noJoins': '暂无关联。添加一个关联（{object} 上的查找字段），即可使用 {path} 形式的维度 / 度量。',
  'engine.inspector.dataset.baseObjectFallback': '基础对象',
  'engine.inspector.dataset.includedRelationship': '包含的关联',
  'engine.inspector.dataset.relationshipPlaceholder': '选择关联…',
  'engine.inspector.dataset.searchRelationships': '搜索关联…',
  'engine.inspector.dataset.removeRelationship': '移除关联',
  'engine.inspector.dataset.scopeFilter': '范围筛选',
  'engine.inspector.dataset.scopeFilterHelp': '固有范围，以 AND 并入每一次查询（例如排除已软删除的记录）。',
  'engine.inspector.dataset.dimensions': '维度',
  'engine.inspector.dataset.addDimension': '添加维度',
  'engine.inspector.dataset.dimensionN': '维度 {index}',
  'engine.inspector.dataset.removeDimension': '移除维度',
  'engine.inspector.dataset.dimensionNamePlaceholder': '例如：region',
  'engine.inspector.dataset.field': '字段',
  'engine.inspector.dataset.dimensionFieldPlaceholder': '字段 或 关联.字段',
  'engine.inspector.dataset.type': '类型',
  'engine.inspector.dataset.labelOptional': '显示名（可选）',
  'engine.inspector.dataset.displayLabel': '显示名',
  'engine.inspector.dataset.dateBucket': '日期分桶',
  'engine.inspector.dataset.measures': '度量',
  'engine.inspector.dataset.addMeasure': '添加度量',
  'engine.inspector.dataset.measureN': '度量 {index}',
  'engine.inspector.dataset.removeMeasure': '移除度量',
  'engine.inspector.dataset.measureNamePlaceholder': '例如：revenue',
  'engine.inspector.dataset.aggregate': '聚合方式',
  'engine.inspector.dataset.measureFieldPlaceholder': '字段（count 时可选）',
  'engine.inspector.dataset.measureFilter': '筛选（度量级）',
  'engine.inspector.dataset.measureFilterHelp': '只有满足此筛选的行才计入该度量（例如 won_amount = sum(amount) where stage = won）。',
  'engine.inspector.dataset.derived': '派生 —— 由其他度量计算',
  'engine.inspector.dataset.operation': '运算',
  'engine.inspector.dataset.operands': '操作数（其他度量）',
  'engine.inspector.dataset.derivedNeedTwo': '{op} 需要恰好选择 2 个度量。',
  'engine.inspector.dataset.derivedNeedOne': '{op} 至少需要选择 1 个度量。',
  'engine.inspector.dataset.addOtherMeasuresFirst': '请先添加其他度量。',
  'engine.inspector.dataset.advanced': '高级',
  'engine.inspector.dataset.displayFormat': '显示格式',
  'engine.inspector.dataset.decimals': '小数位数',
  'engine.inspector.dataset.currency': '货币',
  'engine.inspector.dataset.sample': '示例：{sample}',
  'engine.inspector.dataset.relWarning': '关联 {rel} 不在「包含的关联」中。',
  'engine.inspector.dataset.relWarningAdd': '添加它',
  'engine.inspector.dataset.filterAdvanced': '高级筛选（嵌套 / OR）—— 请在「{source}」标签页中编辑。',
  'engine.inspector.dataset.sourceTab': '源码',
  'engine.inspector.dataset.filterConditionsOne': '{count} 个条件',
  'engine.inspector.dataset.filterConditionsOther': '{count} 个条件',
  'engine.inspector.dataset.addFilter': '+ 添加筛选…',
  'engine.inspector.dataset.filterNeedsObject': '先选择基础对象，才能添加筛选条件。',
  // Flow reference picker — ReferenceCombobox / FlowReferenceField (objectui#10586)
  'engine.inspector.reference.pickFromRecords': '从记录中选择',
  'engine.inspector.reference.enterManually': '手动输入值',
  'engine.inspector.reference.managerPlaceholder': '自动解析',
  'engine.inspector.reference.managerHint': '运行时根据提交人的上级自动解析 —— 无需填写。',
  'engine.inspector.reference.queueUnsupported': '运行时暂不支持队列审批人 —— 该位置不会解析到任何人。',
  'engine.inspector.reference.fieldsOf': '{object} 的字段。',
  'engine.inspector.reference.setTriggerObject': '请先在开始节点上设置流程的触发对象，才能列出字段。',
  ...
  // InspectorComboField defaults (objectui#10586).
  'engine.inspector.combo.search': '搜索或输入…',
  'engine.inspector.combo.noMatch': '无匹配项 —— 继续输入即可使用自定义值。',
  'engine.inspector.combo.loading': '加载中…',
  'engine.inspector.combo.useCustom': '使用 {value}',
