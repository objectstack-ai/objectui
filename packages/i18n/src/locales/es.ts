const es = {
  ...
  calendar: {
    ...
    configRequired: "Se requiere la configuración del calendario. Indica startDateField, la única clave obligatoria del calendario; el título del evento se resuelve sin titleField.",
    configRequiredHint: "Pertenece al bloque calendar de la vista. Una página de interfaz no tiene su propio espacio de calendario: apunta su sourceView a una vista que declare uno.",
    eventDetails: "Detalles del evento",
    pullToRefresh: "Desliza para actualizar",
    refreshing: "Actualizando…",
    onDate: "El {{date}}",
    eventTitle: "Título",
    eventTitlePlaceholder: "¿De qué trata este evento?",
    creating: "Creando…",
  ...
  empty: {
    ...
    appNotAvailableDescription: "Esta aplicación no está disponible — vuelva a intentarlo en un momento.",
    appNotFound: "No se puede abrir esta aplicación",
    appNotFoundDescription: "El servidor no devolvió esta aplicación para su cuenta.",
    appUnreachable: "No se pudo conectar con el servidor",
    appUnreachableDescription: "No se pudo comprobar esta aplicación. Vuelva a intentarlo en un momento.",
