const pt = {
  ...
  calendar: {
    ...
    loadError: "Erro: {{message}}",
    configRequired: "Configuração do calendário necessária. Informe startDateField, a única chave obrigatória do calendário; o título do evento é resolvido sem titleField.",
    configRequiredHint: "Ela pertence ao bloco calendar da visão. Uma página de interface não tem espaço de calendário próprio: aponte o sourceView dela para uma visão que declare um.",
  ...
  empty: {
    ...
    appNotAvailableDescription: "Este aplicativo não está disponível — tente novamente em instantes.",
    appNotFound: "Não é possível abrir este aplicativo",
    appNotFoundDescription: "O servidor não retornou este aplicativo para a sua conta.",
    appUnreachable: "Não foi possível acessar o servidor",
    appUnreachableDescription: "Não foi possível verificar este aplicativo. Tente novamente em instantes.",
