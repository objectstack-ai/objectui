...
instead of the ObjectQL tuple (objectui#8255, the docs half of the objectui#7928 ruling).

The `@object-ui/types` pin that held the refused forms as "still what the docs teach" now asserts the
successor: it reads every named view the three pages author off disk with the TypeScript parser and
