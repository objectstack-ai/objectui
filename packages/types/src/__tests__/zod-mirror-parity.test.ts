 ...
 *   - **7 entries** in `WiderThanDeclared`, **10 keys** across them, and **10 arms**
 *     under those keys — split **5** SCHEMA-NODE, **5** CONCRETE, **0** MIXED, **0** unions.
 *     It read 8 / 11 / 12 — 5 / 6 / 0 / 1 — until objectui#10387 RETIRED
