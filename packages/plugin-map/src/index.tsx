...
/**
 * The authoring surface both `ObjectMapRenderer` tags publish, spelled ONCE and
 * spread into both registrations, as `plugin-calendar` does for its two tags
 * (objectui#8201): the same renderer cannot have two declared surfaces.
 *
 ...
 * ObjectMap`). Pinned in `index.recordSourceInputs-10394.test.tsx`.
 */
const OBJECT_MAP_INPUTS: ComponentInput[] = [
...
ComponentRegistry.register('object-map', ObjectMapRenderer, {
  ...
  label: 'Object Map',
  category: 'view',
  inputs: [...OBJECT_MAP_INPUTS],
});

// `map` stays registered and publishes the same surface; whether the bare key
// survives at all is objectui#10393's question, not this list's.
