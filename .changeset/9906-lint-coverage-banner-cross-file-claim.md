...
both; both halves were true when the sentence was written and both had gone
false before anyone read it again, each falsified by a different pull request
and neither by the one that wrote the sentence. The trade-off the banner exists to explain —
