const ar = {
  ...
  empty: {
    ...
    appNotAvailableDescription: "هذا التطبيق غير متاح — أعد المحاولة بعد لحظات.",
    appNotFound: "تعذّر فتح هذا التطبيق",
    appNotFoundDescription: "لم يُرجع الخادم هذا التطبيق لحسابك.",
    appUnreachable: "تعذّر الوصول إلى الخادم",
    appUnreachableDescription: "تعذّر التحقق من هذا التطبيق. أعد المحاولة بعد لحظات.",
