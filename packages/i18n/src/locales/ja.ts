const ja = {
  ...
  empty: {
    ...
    appNotAvailableDescription: "このアプリは利用できません — しばらくしてからもう一度お試しください。",
    appNotFound: "このアプリを開けません",
    appNotFoundDescription: "サーバーはお使いのアカウントに対してこのアプリを返しませんでした。",
    appUnreachable: "サーバーに接続できませんでした",
    appUnreachableDescription: "このアプリを確認できませんでした。しばらくしてからもう一度お試しください。",
