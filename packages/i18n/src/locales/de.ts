const de = {
  ...
  empty: {
    ...
    appNotAvailableDescription: "Diese App ist nicht verfügbar — versuchen Sie es in einem Moment erneut.",
    appNotFound: "Diese App kann nicht geöffnet werden",
    appNotFoundDescription: "Der Server hat diese App für Ihr Konto nicht zurückgegeben.",
    appUnreachable: "Der Server ist nicht erreichbar",
    appUnreachableDescription: "Diese App konnte nicht geprüft werden. Versuchen Sie es in einem Moment erneut.",
